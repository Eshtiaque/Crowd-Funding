              ...
              <div className="mx-auto text-center mt-12">
                ...
                <div className=" md:mt-0 lg:mt-0">
                  ...
                  <Link to="/donate">
                    <motion.button 
                      type="button"
                      className="button-sm ml-5 mt-8  text-xl font-semibold h-14 w-48 bg-white text-black hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 px-4 tracking-wider text-center rounded-full mr-3 md:mr-0 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 hover:text-white"
                      variants={{
                        hidden: { opacity: 0, y: 75 },
                        visible: { opacity: 1, y: 0 }
                      }}
