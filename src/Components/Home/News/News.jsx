            ...
            <div className="text-end">
                <Link to="/allNews">
                    <motion.button
                        ...
                        className="btn w-1/4 mb-3 mr-3 text-white bg-gradient-to-br mt-5 from-blue-500 to-purple-500 hover:from-purple-600 hover:to-blue-600  "
                        >See more <BsFillArrowRightCircleFill className="text-xl bg-gradient-to-br from-blue-500 to-purple-500 hover:text-black" />
                        </motion.button>
                        </Link>
            </div>
